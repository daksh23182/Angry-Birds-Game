...
public class LoadGamePromptScreen3 implements Screen {
    ...
    public LoadGamePromptScreen3(AngryBirdd game) {
        this.game = game;
        ...
        if (Gdx.input.isTouched()) {
            ...
            if (mouseX > loadButtonX && mouseX < loadButtonX + buttonWidth &&
                ...
                if (Gdx.files.local("Level3.save").exists()) {
                    ...
                    game.setScreen(new PlayScreen3(game, "Level3.save")); // Load the saved game
                } else {
                    System.out.println("No saved game found. Starting a new game...");
                    game.setScreen(new PlayScreen3(game)); // Start a new game
                }
            }
